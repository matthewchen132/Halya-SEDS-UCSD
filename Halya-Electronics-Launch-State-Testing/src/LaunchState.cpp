...
#define ERROR_RANGE 25 // At least 
...
const double EXPECTED_ACCELERATION = 9.81;
...
void BabyStateMachine(SixDOF &_6DOF1, PHT &alt1, MPU9250 &mpu1, GPS &gps1, SixDOF &_6DOF2, PHT &alt2, MPU9250 &mpu2, GPS &gps2)
{
